 ...
 * {@link Student_Profile.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Student_Profile#newInstance} factory method to
...
public class Student_Profile extends Fragment {
    ...
    private TextView tv_student_profile;
    ...
    public static Student_Profile newInstance(String param1, String param2) {
...
//        return inflater.inflate(R.layout.fragment_student__profile, container, false);
        final View v=  inflater.inflate(R.layout.fragment_student__profile, container, false);

        ImageView logo_img =(ImageView)v.findViewById(R.id.logo_imgg);

        RelativeLayout rt =(RelativeLayout)v.findViewById(R.id.option_lay);
        rt.animate().translationX(700);
