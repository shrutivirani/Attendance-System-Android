...
//        return inflater.inflate(R.layout.fragment_faq, container, false);
        ...
        tv_faq = (TextView)v.findViewById(R.id.tv_faq);

        final Typeface myfont = Typeface.createFromAsset(getActivity().getAssets(), "font/monotype.ttf");

        tv_faq.setTypeface(myfont);
        return v;
    }
